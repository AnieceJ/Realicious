      ...
      >
        ...
        <div className="flex flex-col gap-3">
          <label>
            ...
            readOnly
            className="w-full px-3 py-2 border-2 border-[#3D2419] bg-gray-100 text-sm font-normal"
            />
          </label>
          <label 
          className="flex flex-col gap-1">
            <span className="text-sm">手機號碼</span>
            <input type="tel" value={mockUser.phone}
            readOnly
            className="w-full px-3 py-2 border-2 border-[#3D2419] bg-gray-100 text-sm font-normal cursor-not-allowed" />
          </label>
        </div>
      </div>
    </div>
