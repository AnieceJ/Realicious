        ...
        <div className="w-110 h-180 bg-white flex flex-col items-center">
          ...
          >
            ...
            <button
              type="submit"
              disabled={submit}
              className={` border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] w-55 h-15 bg-[#F02A2D] text-white text-[26px] cursor-pointer hover:bg-[#e50004] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]`}
            >
              {submit?`loading`:`確認送出`}
            </button>
          </form>
